				...
				<div className={'game'}>
					...
					<div className={'game-descr-container'}>
						<p className={'game-descr'}>
							Профессиональный тренажер-симулятор для отработки навыков противодействия беспилотным летательным аппаратам. 
							Предназначен для подготовки специалистов силовых структур, вооруженных сил, 
							а также персонала, ответственного за безопасность критической инфраструктуры.
						</p>
